...
033[1;96m'harshudubey\033[1;97m•◈•▬ ▬harshu dubey•◈•" ▬ ▬ ▬ ▬•◈•"

\033[1;91m☞ Auther     : harshudubey
\033[1;92m☞ WhatsApp   : xxxxxxxxxxxx
\033[1;95m☞ YouTube    : https://www.youtube.com/channel/UC3S835IJhJvZiTL04O0AHBg
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update harshudubey Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' harshit dubey WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/harshudubey')
	    ...
	    psb('WhatsApp Num xxxxxxxxx✓')
	    psb('WellCome To harshudubey')
	    psb('Congratulations lovehacker Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ harshit')
	    psb('🔓Password ☆ ruchika3')
	    psb('Subscrib My Youtube Chenal fb trick hour')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/BlackMafia && python2 Ruchika5.py')
	elif bm =='3':
